...
- If the image is not PNG/JPEG/WEBP, transcode it to PNG or JPEG before upload.
  Fix Example: If you read a .jpg but the content is actually PNG after conversion or compression — invalid. Always re-detect and update the MIME after transformations.
